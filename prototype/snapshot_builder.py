...
def classificar_grouping_em_bloco(g, registry_por_id, linhas_carteiras_por_id, inicio_janela, fim_janela):
    ...
    Pseudocódigo:
      ...
      4. Sem membro rastreado -> bloco 3. Com rastreado e alguma carteira
         com mockkey ∉ {"p","cD"} na data de referência (= "tem
         pendência", [REVISADO 2026-07-24, pedido do usuário] antes era
         "tier ≤ 2") -> bloco 1. Senão -> bloco 2.
    """
...
def montar_tooltip_celula_grouping(ativos, data, lookup_celulas):
    ...
    nesse dia (mockkey ∉ {"p","cD"}) — [2026-07-24, pedido do usuário:
    ...
    Pseudocódigo:
      ...
      2. Conta 1 no mockkey da célula; se o mockkey não é "p"/"cD"
